...
const projects = [
  ...
  },
  {
    ...
    description: "This project brought together several of my creative strengths: design, coding, illustration, and audio. I’m especially proud of how we elevated a simple concept with personalized touches like pixel art and sound design. It was a valuable exercise in UI development and cross-disciplinary creativity.",
  ...
  },
  {
    ...
    subhead: "COMPSA launched a new initiative called COMPSA Circuit to host tech challenges and events throughout the school year. These events were all aimed at boosting student engagement in a fun, competitive way. I was brought in to build the brand identity.",
    images: ["/compsa3.png"],
    description: "This project helped me level up my logo design skills, especially incorporating visual symbolism (like the circuit lines) in a clean and readable way.",
    skills: "Figma",
    websiteLink: "",
  },
  {
    ...
    subhead: "During my time as Social Media Coordinator for QWAVE, I was responsible for creating event graphics that reflected the club’s identity and helped promote music production-related workshops and gatherings. The goal was to establish a visual style that matched QWAVE’s creative energy while maintaining clarity and consistency across platforms.",
